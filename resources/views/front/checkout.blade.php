                ...
                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            <select name="country" id="country" class="form-control">
                                                ...
                                                @forelse ($countries as $country)
                                                    <option @selected($customerAddress?->country_id == $country->id) value="{{ $country->id }}">{{ $country->name }}</option>
                                                @empty
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card payment-form ">
                            ...
                            <h3 class="h5 card-title mb-3">Payment Method</h3>
...
@section('customJs')
    <script>
        $("input[name='payment_method']").on('change', function() {
            $('#card-payment-form').toggleClass('d-none', $(this).val() !== 'stripe');
        });
        ...
        $("#orderForm").submit(function(e) {
            ...
            $.post({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        location.href = "{{ url('/thanks/') }}/" + response.orderId;
                    } else {
